...
public class Fac/*@bgen(jjtree)*/implements FacTreeConstants, FacConstants {/*@bgen(jjtree)*/
  ...
  static boolean contains(final int[] array, final int v) throws ParseException {
 ...
 try {boolean result = false;
  ...
  static void error_skipto(int[] kinds) throws ParseException {
...
try {ParseException e = generateParseException();  // generate the exception object.
        ...
        case DOT:
          ...
          try {
            ...
            case OPEN_PARENTHESES:
             y=3;
              jj_consume_token(OPEN_PARENTHESES);
                                        ASTParenteses jjtn002 = new ASTParenteses(JJTPARENTESES);
              ...
              try {
                ...
                default:
                  ...
                  ;
                                        ...
                                        if (jjtc002) {
                                          jjtree.closeNodeScope(jjtn002,  x);
                                        }
              }
              jj_consume_token(CLOSE_PARENTHESES);
              break;
          ...
          if (jjtc003) {
            jjtree.closeNodeScope(jjtn003,  y);
          }
          }
          break;
        default:
  ...
  static final public void Term(int sign) throws ParseException {
                       /*@bgen(jjtree) Term */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x200,0x0,0x18000,0x100,0x18040,0x40000,0x18000,0xc5002800,0x10000000,0x18000,0xc5002800,0x820000,0xc5002800,0x40000,0xc4000000,0x4000000,0x10000000,0x10000000,0x0,0x180000,0x180000,0x600000,0x600000,0x0,0xc4008000,0xc4000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x8,0x2000,0x0,0x2000,0x0,0x2000,0x3e17,0x0,0x2000,0x3e17,0x0,0x3e17,0x0,0x3e17,0x0,0x120,0x120,0x40,0x0,0x0,0x0,0x0,0x1e00,0x3e17,0x3e17,};
   }
